...
const contributions = [
  ...
  'Design and develop functional protpotype utilizes glass and writst based wearable hardware',
  'Integrate wearable application Conduct usability study of the solution with first responders',
]
