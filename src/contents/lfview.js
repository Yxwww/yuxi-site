...
const contributions = [
  ...
  'Maximize productivities by balancing between various testing philosophies while maintaining over 95% test coverage.',
...
const description = `
Web developer of 3D data visualization web application LFview. Led frontend stack redesign from ground up to the React/Redux/Rxjs/Polymer/ThreeJS based web app.
