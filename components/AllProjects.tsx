  ...
  return (
    <div className="grid grid-cols-1 gap-4">
      <PostLink
        ...
        description="I created my personal website to jog down long-form thoughts on programming and software development. Built with Vercel, TailwindCSS, and Markdoc, the site's code is publicly available."
